...
import type { DiscordError } from '~/shared/discord/discord';
...
<template>
	<div class="flex items-center gap-2 bg-red-100 dark:bg-red-500 text-red-800 dark:text-red-100 rounded-md p-2">
