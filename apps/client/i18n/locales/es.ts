	...
	components: {
		...
		tools: {
			...
			qrcode_generator: {
				...
				image_options: 'Anexar Imagen',
				url_shorten: 'Acortar URL',
				options: {
					type: {
...
Esperamos que esto sea claro, y como se mencionó anteriormente, si hay algo de lo que no está seguro si necesita o no, generalmente es más seguro dejar las cookies habilitadas en caso de que interactúe con una de las funciones que utiliza en nuestro sitio web.
	...
	tools: {
		...
		discord_message_builder: {
			name: 'Generador de Mensajes para Discord',
			description:
	...
	workers: {
		image_converter: {
			progress: {
				converting_image: 'Convirtiendo imagen...'
			}
		},
		image_pixelate: {
			progress: {
